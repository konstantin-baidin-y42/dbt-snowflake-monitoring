...
query_history as (
    select
        *,
        ...
        case
            when _dbt_json_comment_meta is not null or _dbt_json_query_tag_meta is not null then merge_objects(coalesce(_dbt_json_comment_meta, { }), coalesce(_dbt_json_query_tag_meta, { }))
        end as dbt_metadata
